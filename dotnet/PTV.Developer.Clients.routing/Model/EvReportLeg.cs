...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class EvReportLeg : IEquatable<EvReportLeg>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="batteryStateOfCharge">The remaining battery capacity at the end of the leg [%]. (required).</param>
        ...
        /// </summary>
        /// <value>The remaining battery capacity at the end of the leg [%].</value>
        ...
        {
            return this.Equals(input as EvReportLeg);
        }

        /// <summary>
        /// Returns true if EvReportLeg instances are equal
        /// </summary>
        /// <param name="input">Instance of EvReportLeg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EvReportLeg input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.WeatherAtStart == input.WeatherAtStart ||
                    (this.WeatherAtStart != null &&
                    this.WeatherAtStart.Equals(input.WeatherAtStart))
                ) && 
                (
                    this.WeatherAtEnd == input.WeatherAtEnd ||
                    (this.WeatherAtEnd != null &&
                    this.WeatherAtEnd.Equals(input.WeatherAtEnd))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WeatherAtStart != null)
                {
                    hashCode = (hashCode * 59) + this.WeatherAtStart.GetHashCode();
                }
                if (this.WeatherAtEnd != null)
                {
                    hashCode = (hashCode * 59) + this.WeatherAtEnd.GetHashCode();
                }
                return hashCode;
            }
        }
