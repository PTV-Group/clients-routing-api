...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class LowEmissionZoneEvent : IEquatable<LowEmissionZoneEvent>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as LowEmissionZoneEvent);
        }

        /// <summary>
        /// Returns true if LowEmissionZoneEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of LowEmissionZoneEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LowEmissionZoneEvent input)
        {
            if (input == null)
            {
                return false;
