...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class RouteResponse : IValidatableObject
    {
        ...
        public RouteResponse(int? distance = default(int?), int? travelTime = default(int?), int? trafficDelay = default(int?), bool? violated = default(bool?), Guid? routeId = default(Guid?), List<Leg> legs = default(List<Leg>), Toll toll = default(Toll), string polyline = default(string), List<Event> events = default(List<Event>), Emissions emissions = default(Emissions), List<AlternativeRoute> alternativeRoutes = default(List<AlternativeRoute>), ScheduleReport scheduleReport = default(ScheduleReport), EvReport evReport = default(EvReport), string guidedNavigation = default(string), MonetaryCosts monetaryCosts = default(MonetaryCosts), List<Warning> warnings = default(List<Warning>))
        {
            ...
            if (violated == null)
            {
                throw new ArgumentNullException("violated is a required property for RouteResponse and cannot be null");
            }
        ...
        [DataMember(Name = "guidedNavigation", EmitDefaultValue = true)]
