...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class EmissionOptions : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CalculationMethods, length must be greater than 1.", new [] { "CalculationMethods" });
            }
