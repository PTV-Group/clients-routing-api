...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class Options : IEquatable<Options>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Comma-separated list of features which should be avoided on the route. Avoided features could be included in a route if there is no possibility to reach the target otherwise. * &#x60;TOLL&#x60; - Avoid roads with toll. * &#x60;FERRIES&#x60; - Avoid ferries. Ferries which cannot be avoided can be requested with _COMBINED_TRANSPORT_EVENTS_ and will appear with the type _BOAT_. * &#x60;RAIL_SHUTTLES&#x60; - Avoid rail shuttles. Rail shuttles which cannot be avoided can be requested with _COMBINED_TRANSPORT_EVENTS_ and will appear with the type _RAIL_.   Cannot be used with **options[routingMode]&#x3D;MONETARY**.  Available values are provided by type &#x60;AvoidFeature&#x60;.</value>
        ...
        public bool Equals(Options input)
        {
            ...
            return 
                ...
                (
                    this.TollTime == input.TollTime ||
                    (this.TollTime != null &&
                    this.TollTime.Equals(input.TollTime))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TollTime != null)
                {
                    hashCode = (hashCode * 59) + this.TollTime.GetHashCode();
                }
