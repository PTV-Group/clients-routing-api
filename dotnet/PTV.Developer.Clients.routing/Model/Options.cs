...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class Options : IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "polylineMapType", EmitDefaultValue = true)]
        public PolylineMapType? PolylineMapType { get; set; }
        ...
        /// <param name="polylineMapType">polylineMapType.</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PolylineMapType: ").Append(PolylineMapType).Append("\n");
