...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class Options : IValidatableObject
    {
        ...
        /// <param name="maximumSpeed">The maximum speed of the vehicle. The speeds for calculating the driving times on all roads will be limited to this value.  See [here](./concepts/speeds) for more information..</param>
        ...
        /// <summary>
        /// The maximum speed of the vehicle. The speeds for calculating the driving times on all roads will be limited to this value.  See [here](./concepts/speeds) for more information.
        /// </summary>
        /// <value>The maximum speed of the vehicle. The speeds for calculating the driving times on all roads will be limited to this value.  See [here](./concepts/speeds) for more information.</value>
