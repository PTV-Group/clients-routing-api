...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class Currencies : IValidatableObject
    {
        /// <summary>
        ...
        public Currencies(DateOnly date = default(DateOnly), string provider = default(string), string baseCurrency = default(string), List<ExchangeRate> exchangeRates = default(List<ExchangeRate>))
        {
            // to ensure "date" is required (not null)
            if (date == null)
            {
                throw new ArgumentNullException("date is a required property for Currencies and cannot be null");
            }
            this.Date = date;
