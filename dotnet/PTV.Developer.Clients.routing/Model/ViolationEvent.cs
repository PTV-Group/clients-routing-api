...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class ViolationEvent : IValidatableObject
    {
        ...
        /// <param name="violatedVehicleProperties">Contains the list of violated vehicle properties at this event. Only present if **type&#x3D;VEHICLE_PROPERTY**. .</param>
        /// <param name="temporary">States whether the cause of the violation is only temporary, e.g. a road construction site. In such cases  see the corresponding traffic event for more information. .</param>
        /// <param name="timeDomain">Returns the time validity of the violated restriction in the GDF time domain format if the restriction is only active at certain times. See [here](./concepts/date-and-time#gdftimedomains) for more information..</param>
        ...
        public ViolationEvent(ViolationType type = default(ViolationType), List<ScheduleViolationType> scheduleViolationTypes = default(List<ScheduleViolationType>), List<ViolatedVehicleProperty> violatedVehicleProperties = default(List<ViolatedVehicleProperty>), bool? temporary = default(bool?), string timeDomain = default(string), AccessType? accessType = default(AccessType?), int? relatedEventIndex = default(int?), string polyline = default(string))
        {
            this.Type = type;
        ...
        /// </summary>
        /// <value>Contains the list of violated vehicle properties at this event. Only present if **type&#x3D;VEHICLE_PROPERTY**. </value>
        [DataMember(Name = "violatedVehicleProperties", EmitDefaultValue = false)]
        public List<ViolatedVehicleProperty> ViolatedVehicleProperties { get; set; }
        ...
        /// </summary>
        /// <value>States whether the cause of the violation is only temporary, e.g. a road construction site. In such cases  see the corresponding traffic event for more information. </value>
        ...
        /// </summary>
        /// <value>Returns the time validity of the violated restriction in the GDF time domain format if the restriction is only active at certain times. See [here](./concepts/date-and-time#gdftimedomains) for more information.</value>
        /// <example>[(y2016M2h10){m30}]</example>
        [DataMember(Name = "timeDomain", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ViolatedVehicleProperties: ").Append(ViolatedVehicleProperties).Append("\n");
            sb.Append("  Temporary: ").Append(Temporary).Append("\n");
            sb.Append("  TimeDomain: ").Append(TimeDomain).Append("\n");
