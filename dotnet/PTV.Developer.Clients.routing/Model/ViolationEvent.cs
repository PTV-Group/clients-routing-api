...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class ViolationEvent : IEquatable<ViolationEvent>, IValidatableObject
    {
        ...
        public ViolationEvent(ViolationType type = default(ViolationType), List<ScheduleViolationType> scheduleViolationTypes = default(List<ScheduleViolationType>), List<ViolatedVehicleProperty> violatedVehicleProperties = default(List<ViolatedVehicleProperty>), bool temporary = default(bool), AccessType? accessType = default(AccessType?), int relatedEventIndex = default(int), string polyline = default(string))
        {
            this.Type = type;
        ...
        public bool Equals(ViolationEvent input)
        {
            ...
            return 
                ...
                (
                    this.ViolatedVehicleProperties == input.ViolatedVehicleProperties ||
                    this.ViolatedVehicleProperties != null &&
                    input.ViolatedVehicleProperties != null &&
                    this.ViolatedVehicleProperties.SequenceEqual(input.ViolatedVehicleProperties)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ViolatedVehicleProperties.GetHashCode();
                }
