...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class TimeInterval : IValidatableObject
    {
        ...
        public TimeInterval(DateTimeOffset? start = default(DateTimeOffset?), DateTimeOffset? end = default(DateTimeOffset?))
        {
            ...
            if (start == null)
            {
                throw new ArgumentNullException("start is a required property for TimeInterval and cannot be null");
            }
            this.Start = start;
            // to ensure "end" is required (not null)
            if (end == null)
            {
                throw new ArgumentNullException("end is a required property for TimeInterval and cannot be null");
            }
            this.End = end;
        }
