...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class EmissionsEN162582012 : IValidatableObject
    {
        ...
        public EmissionsEN162582012(double? fuelConsumption = default(double?), double? co2eTankToWheel = default(double?), double? co2eWellToWheel = default(double?), double? energyUseTankToWheel = default(double?), double? energyUseWellToWheel = default(double?))
        {
            ...
            {
                throw new ArgumentNullException("fuelConsumption is a required property for EmissionsEN162582012 and cannot be null");
            }
            this.FuelConsumption = fuelConsumption;
            // to ensure "co2eTankToWheel" is required (not null)
            if (co2eTankToWheel == null)
            {
                throw new ArgumentNullException("co2eTankToWheel is a required property for EmissionsEN162582012 and cannot be null");
            }
            this.Co2eTankToWheel = co2eTankToWheel;
            // to ensure "co2eWellToWheel" is required (not null)
            if (co2eWellToWheel == null)
            {
                throw new ArgumentNullException("co2eWellToWheel is a required property for EmissionsEN162582012 and cannot be null");
            }
            this.Co2eWellToWheel = co2eWellToWheel;
            // to ensure "energyUseTankToWheel" is required (not null)
            if (energyUseTankToWheel == null)
            {
                throw new ArgumentNullException("energyUseTankToWheel is a required property for EmissionsEN162582012 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("energyUseWellToWheel is a required property for EmissionsEN162582012 and cannot be null");
            }
