...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class ElectricityPrice : IEquatable<ElectricityPrice>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ElectricityPrice);
        }

        /// <summary>
        /// Returns true if ElectricityPrice instances are equal
        /// </summary>
        /// <param name="input">Instance of ElectricityPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ElectricityPrice input)
        {
            if (input == null)
            {
                return false;
