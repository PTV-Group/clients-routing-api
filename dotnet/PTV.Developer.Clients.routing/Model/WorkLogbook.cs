...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class WorkLogbook : IEquatable<WorkLogbook>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The last time the driver worked formatted according to [RFC 3339](https://tools.ietf.org/html/rfc3339).   If the date-time string does not include an explicit offset to UTC, the time will be interpreted as the local time of the start waypoint. The date must not be before 1970-01-01T00:00:00+00:00 nor after 2037-12-31T23:59:59+00:00.   See [here](./concepts/date-and-time) for more information on the relevance of date and time.</value>
        ...
        [DataMember(Name = "accumulatedWorkingTimeSinceLastBreak", EmitDefaultValue = false)]
        ...
        [DataMember(Name = "accumulatedDrivingTimeSinceLastDailyRest", EmitDefaultValue = false)]
        ...
        [DataMember(Name = "accumulatedTravelTimeSinceLastDailyRest", EmitDefaultValue = false)]
