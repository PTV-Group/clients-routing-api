...
namespace PTV.Developer.Clients.routing.Api
{
    ...
    public interface IRoutingApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RouteResponse</returns>
        RouteResponse CalculateRoutePost(RouteRequest routeRequest, string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Driver? driver = default(Driver?), Options? options = default(Options?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), EvOptions? evOptions = default(EvOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0);
    ...
    public interface IRoutingApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RouteResponse</returns>
        System.Threading.Tasks.Task<RouteResponse> CalculateRoutePostAsync(RouteRequest routeRequest, string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Driver? driver = default(Driver?), Options? options = default(Options?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), EvOptions? evOptions = default(EvOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class RoutingApi : IRoutingApi
    {
        ...
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> localVarResponse = CalculateRoutePostWithHttpInfo(routeRequest, profile, vehicle, driver, options, monetaryCostOptions, evOptions, results);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<RouteResponse> CalculateRoutePostAsync(RouteRequest routeRequest, string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Driver? driver = default(Driver?), Options? options = default(Options?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), EvOptions? evOptions = default(EvOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> localVarResponse = await CalculateRoutePostWithHttpInfoAsync(routeRequest, profile, vehicle, driver, options, monetaryCostOptions, evOptions, results, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<EtaResponse> localVarResponse = GetEstimatedTimeOfArrivalWithHttpInfo(routeId, waypoint, position, workLogbook);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EtaResponse</returns>
        public PTV.Developer.Clients.routing.Client.ApiResponse<EtaResponse> GetEstimatedTimeOfArrivalWithHttpInfo(Guid routeId, PositionAtWaypoint? waypoint = default(PositionAtWaypoint?), PositionOnRoute? position = default(PositionOnRoute?), WorkLogbook? workLogbook = default(WorkLogbook?), int operationIndex = 0)
        {
            PTV.Developer.Clients.routing.Client.RequestOptions localVarRequestOptions = new PTV.Developer.Clients.routing.Client.RequestOptions();
			localVarRequestOptions.HeaderParameters.Add("User-Agent","ptv-generated csharp client");
        ...
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<EtaResponse> localVarResponse = await GetEstimatedTimeOfArrivalWithHttpInfoAsync(routeId, waypoint, position, workLogbook, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
