...
namespace PTV.Developer.Clients.routing.Api
{
    ...
    public interface IRoutingApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="PTV.Developer.Clients.routing.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="routeId">Route ID returned from a previous route calculation or alternative route.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RouteResponse</returns>
    ...
    public partial class RoutingApi : IRoutingApi
    {
        ...
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> localVarResponse = CalculateRouteWithHttpInfo(waypoints, routeId, profile, vehicle, options, monetaryCostOptions, results);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RouteResponse</returns>
        public PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> CalculateRouteWithHttpInfo(List<string>? waypoints = default(List<string>?), Guid? routeId = default(Guid?), string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Options? options = default(Options?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0)
        {
        ...
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> localVarResponse = await CalculateRouteWithHttpInfoAsync(waypoints, routeId, profile, vehicle, options, monetaryCostOptions, results, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RouteResponse)</returns>
        public async System.Threading.Tasks.Task<PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse>> CalculateRouteWithHttpInfoAsync(List<string>? waypoints = default(List<string>?), Guid? routeId = default(Guid?), string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Options? options = default(Options?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (vehicle != null)
            {
                localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "vehicle", vehicle));
            }
            if (options != null)
            {
                localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "options", options));
            }
            if (monetaryCostOptions != null)
            {
                localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "monetaryCostOptions", monetaryCostOptions));
            }
            if (results != null)
            {
                localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("csv", "results", results));
        ...
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> localVarResponse = CalculateRoutePostWithHttpInfo(routeRequest, profile, vehicle, driver, options, monetaryCostOptions, results);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<RouteResponse> CalculateRoutePostAsync(RouteRequest routeRequest, string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Driver? driver = default(Driver?), Options? options = default(Options?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> localVarResponse = await CalculateRoutePostWithHttpInfoAsync(routeRequest, profile, vehicle, driver, options, monetaryCostOptions, results, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse>> CalculateRoutePostWithHttpInfoAsync(RouteRequest routeRequest, string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Driver? driver = default(Driver?), Options? options = default(Options?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (driver != null)
            {
                localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "driver", driver));
            }
            if (options != null)
            {
                localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "options", options));
