...
namespace PTV.Developer.Clients.routing.Api
{
    ...
    public interface IRoutingApiSync : IApiAccessor
    {
        ...
        /// <param name="vehicle">Physical and legal properties of the vehicle such as its dimensions to override the values of the selected **profile**.  These parameters will be ignored for non-motorized profiles such as _BICYCLE_ or _PEDESTRIAN_. Unsupported parameters such as **electricityType** for combustion vehicles should not be specified in the request.  Use array notation like &#x60;vehicle[emissionStandard]&#x3D;EURO_5&#x60; to set vehicle attributes. (optional)</param>
        /// <param name="driver">Options regarding the drivers&#39; working hours. (optional)</param>
        /// <param name="options">Routing-relevant options like date of travel or the use of additional data. Use array notation like &#x60;options[trafficMode]&#x3D;AVERAGE&#x60; to set options. (optional)</param>
        /// <param name="emissionOptions">Relevant options to report emissions. Use array notation like &#x60;emissionOptions[calculationMethods]&#x3D;ISO14083_2023&#x60; to set options.  This parameter supersedes emission-related values in **results**.  If specified the emission-related values in **results** will be ignored. (optional)</param>
        /// <param name="monetaryCostOptions">Relevant options to report the monetary costs of a route when _MONETARY_COSTS_ are requested in the **results**. Used for monetary cost routing when **options[routingMode]&#x3D;MONETARY** is set. The costs have to be specified in the currency that is set in **options[currency]**. (optional)</param>
    ...
    public interface IRoutingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<RouteResponse> CalculateRouteAsync(List<string>? waypoints = default(List<string>?), Guid? routeId = default(Guid?), string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Options? options = default(Options?), EmissionOptions? emissionOptions = default(EmissionOptions?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<RouteResponse>> CalculateRouteWithHttpInfoAsync(List<string>? waypoints = default(List<string>?), Guid? routeId = default(Guid?), string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Options? options = default(Options?), EmissionOptions? emissionOptions = default(EmissionOptions?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RouteResponse</returns>
        System.Threading.Tasks.Task<RouteResponse> CalculateRoutePostAsync(RouteRequest routeRequest, string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Driver? driver = default(Driver?), Options? options = default(Options?), EmissionOptions? emissionOptions = default(EmissionOptions?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), EvOptions? evOptions = default(EvOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RouteResponse</returns>
        System.Threading.Tasks.Task<RouteResponse> GetRouteByRouteIdAsync(Guid? routeId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RouteResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<RouteResponse>> GetRouteByRouteIdWithHttpInfoAsync(Guid? routeId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class RoutingApi : IRoutingApi
    {
        ...
        public PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> CalculateRouteWithHttpInfo(List<string>? waypoints = default(List<string>?), Guid? routeId = default(Guid?), string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Options? options = default(Options?), EmissionOptions? emissionOptions = default(EmissionOptions?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0)
        {
            ...
            if (options != null)
            {
                ...
                if (options.PolylineMapType != null)
                {
                    localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "options[polylineMapType]", options.PolylineMapType));
                }
                ...
                if (options.MaximumSpeed != null)
                {
                    localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "options[maximumSpeed]", options.MaximumSpeed));
                }
                if (options.SpeedFactor != null)
                {
                    localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "options[speedFactor]", options.SpeedFactor));
                }
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RouteResponse)</returns>
        public async System.Threading.Tasks.Task<PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse>> CalculateRouteWithHttpInfoAsync(List<string>? waypoints = default(List<string>?), Guid? routeId = default(Guid?), string? profile = default(string?), Vehicle? vehicle = default(Vehicle?), Options? options = default(Options?), EmissionOptions? emissionOptions = default(EmissionOptions?), MonetaryCostOptions? monetaryCostOptions = default(MonetaryCostOptions?), List<Results>? results = default(List<Results>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        public PTV.Developer.Clients.routing.Client.ApiResponse<EtaResponse> GetEstimatedTimeOfArrivalWithHttpInfo(Guid? routeId, PositionAtWaypoint? waypoint = default(PositionAtWaypoint?), PositionOnRoute? position = default(PositionOnRoute?), DateTimeOffset? time = default(DateTimeOffset?), WorkLogbook? workLogbook = default(WorkLogbook?), int operationIndex = 0)
        {
            ...
            if (routeId == null)
            {
                throw new PTV.Developer.Clients.routing.Client.ApiException(400, "Missing required parameter 'routeId' when calling RoutingApi->GetEstimatedTimeOfArrival");
            }
        ...
        public PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse> GetRouteByRouteIdWithHttpInfo(Guid? routeId, int operationIndex = 0)
        {
            ...
            if (routeId == null)
            {
                throw new PTV.Developer.Clients.routing.Client.ApiException(400, "Missing required parameter 'routeId' when calling RoutingApi->GetRouteByRouteId");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RouteResponse</returns>
        public async System.Threading.Tasks.Task<RouteResponse> GetRouteByRouteIdAsync(Guid? routeId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RouteResponse)</returns>
        public async System.Threading.Tasks.Task<PTV.Developer.Clients.routing.Client.ApiResponse<RouteResponse>> GetRouteByRouteIdWithHttpInfoAsync(Guid? routeId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'routeId' is set
            if (routeId == null)
            {
