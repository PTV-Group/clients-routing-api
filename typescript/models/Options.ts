...
import type { PolylineMapType } from './PolylineMapType';
import {
    PolylineMapTypeFromJSON,
    PolylineMapTypeFromJSONTyped,
    PolylineMapTypeToJSON,
} from './PolylineMapType';
...
export interface Options {
     ...
     * @memberof Options
     */
    customRoadAttributeScenarios?: string;
    /**
     * 
     * @type {RoutingMode}
     * @memberof Options
...
export function OptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Options {
    ...
    return {
        ...
        'polylineMapType': json['polylineMapType'] == null ? undefined : PolylineMapTypeFromJSON(json['polylineMapType']),
...
export function OptionsToJSON(value?: Options | null): any {
    ...
    return {
        ...
        'polylineMapType': PolylineMapTypeToJSON(value['polylineMapType']),
