 ...
 */
export function instanceOfScheduleReport(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "drivingTime" in value;
    isInstance = isInstance && "serviceTime" in value;
    isInstance = isInstance && "waitingTime" in value;
    isInstance = isInstance && "breakTime" in value;
    isInstance = isInstance && "restTime" in value;
