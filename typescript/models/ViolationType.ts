 ...
 *  * `DELIVERY_ONLY` - The violated road is prohibited except for delivery vehicles such as factory premises. Cars and vans are no delivery vehicles and may produce such violations.  
...
export function instanceOfViolationType(value: any): boolean {
    for (const key in ViolationType) {
        if (Object.prototype.hasOwnProperty.call(ViolationType, key)) {
            if ((ViolationType as Record<string, ViolationType>)[key] === value) {
                return true;
            }
        }
    }
