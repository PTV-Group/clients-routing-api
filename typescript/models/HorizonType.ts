...
export function instanceOfHorizonType(value: any): boolean {
    for (const key in HorizonType) {
        if (Object.prototype.hasOwnProperty.call(HorizonType, key)) {
            if ((HorizonType as Record<string, HorizonType>)[key] === value) {
                return true;
            }
        }
    }
