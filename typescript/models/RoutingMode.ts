 ...
 * * _FAST_ is the default which returns a route considering a tradeoff between distance and travel time.
...
export function instanceOfRoutingMode(value: any): boolean {
    for (const key in RoutingMode) {
        if (Object.prototype.hasOwnProperty.call(RoutingMode, key)) {
            if (RoutingMode[key as keyof typeof RoutingMode] === value) {
                return true;
            }
        }
    }
