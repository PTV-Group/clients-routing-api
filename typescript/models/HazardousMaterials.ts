...
export function instanceOfHazardousMaterials(value: any): boolean {
    for (const key in HazardousMaterials) {
        if (Object.prototype.hasOwnProperty.call(HazardousMaterials, key)) {
            if ((HazardousMaterials as Record<string, HazardousMaterials>)[key] === value) {
                return true;
            }
        }
    }
