...
export function instanceOfReachableTrafficMode(value: any): boolean {
    for (const key in ReachableTrafficMode) {
        if (Object.prototype.hasOwnProperty.call(ReachableTrafficMode, key)) {
            if ((ReachableTrafficMode as Record<string, ReachableTrafficMode>)[key] === value) {
                return true;
            }
        }
    }
