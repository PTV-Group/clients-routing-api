...
export function instanceOfParticleReductionClass(value: any): boolean {
    for (const key in ParticleReductionClass) {
        if (Object.prototype.hasOwnProperty.call(ParticleReductionClass, key)) {
            if ((ParticleReductionClass as Record<string, ParticleReductionClass>)[key] === value) {
                return true;
            }
        }
    }
