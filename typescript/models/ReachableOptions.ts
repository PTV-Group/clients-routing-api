...
export function ReachableOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReachableOptions {
    ...
    return {
        ...
        'referenceTime': !exists(json, 'referenceTime') ? undefined : (json['referenceTime'] === null ? null : new Date(json['referenceTime'])),
        'trafficMode': !exists(json, 'trafficMode') ? undefined : ReachableTrafficModeFromJSON(json['trafficMode']),
...
export function ReachableOptionsToJSON(value?: ReachableOptions | null): any {
    ...
    return {
        ...
        'referenceTime': value.referenceTime === undefined ? undefined : (value.referenceTime === null ? null : value.referenceTime.toISOString()),
