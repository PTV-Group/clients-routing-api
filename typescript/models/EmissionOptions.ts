 ...
 */
export function instanceOfEmissionOptions(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "calculationMethods" in value;
...
export function EmissionOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EmissionOptions {
    ...
    return {
        ...
        'defaultConsumption': !exists(json, 'defaultConsumption') ? undefined : json['defaultConsumption'],
        'iso14083EmissionFactorsVersion': !exists(json, 'iso14083EmissionFactorsVersion') ? undefined : Iso14083EmissionFactorsVersionFromJSON(json['iso14083EmissionFactorsVersion']),
    };
}
