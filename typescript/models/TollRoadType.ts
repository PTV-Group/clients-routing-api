...
export function instanceOfTollRoadType(value: any): boolean {
    for (const key in TollRoadType) {
        if (Object.prototype.hasOwnProperty.call(TollRoadType, key)) {
            if ((TollRoadType as Record<string, TollRoadType>)[key] === value) {
                return true;
            }
        }
    }
