 ...
 * @export
 */
export const EtcSubscriptionTypes = {
    AT_GOBOX: 'AT_GOBOX',
...
export type EtcSubscriptionTypes = typeof EtcSubscriptionTypes[keyof typeof EtcSubscriptionTypes];


export function instanceOfEtcSubscriptionTypes(value: any): boolean {
    for (const key in EtcSubscriptionTypes) {
        if (Object.prototype.hasOwnProperty.call(EtcSubscriptionTypes, key)) {
            if ((EtcSubscriptionTypes as Record<string, EtcSubscriptionTypes>)[key] === value) {
                return true;
            }
        }
    }
...
export function EtcSubscriptionTypesFromJSON(json: any): EtcSubscriptionTypes {
    return EtcSubscriptionTypesFromJSONTyped(json, false);
}

export function EtcSubscriptionTypesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EtcSubscriptionTypes {
    return json as EtcSubscriptionTypes;
}

export function EtcSubscriptionTypesToJSON(value?: EtcSubscriptionTypes | null): any {
    return value as any;
}
