...
export interface Vehicle {
     ...
     * @memberof Vehicle
     */
    lowEmissionZoneApprovals?: string;
    /**
     * 
    ...
    width?: number;
    /**
     * Comma-separated list of hazardous materials the vehicle has loaded. If none of the specific values applies,
...
export function VehicleFromJSONTyped(json: any, ignoreDiscriminator: boolean): Vehicle {
    ...
    return {
        ...
        'lowEmissionZoneTypes': json['lowEmissionZoneTypes'] == null ? undefined : json['lowEmissionZoneTypes'],
        ...
        'hazardousMaterials': json['hazardousMaterials'] == null ? undefined : json['hazardousMaterials'],
        'tunnelRestrictionCode': json['tunnelRestrictionCode'] == null ? undefined : TunnelRestrictionCodeFromJSON(json['tunnelRestrictionCode']),
        'truckRoutes': json['truckRoutes'] == null ? undefined : json['truckRoutes'],
