...
export function VehicleFromJSONTyped(json: any, ignoreDiscriminator: boolean): Vehicle {
    ...
    return {
        ...
        'lowEmissionZoneApprovals': !exists(json, 'lowEmissionZoneApprovals') ? undefined : json['lowEmissionZoneApprovals'],
        ...
        'totalTechnicallyPermittedWeight': !exists(json, 'totalTechnicallyPermittedWeight') ? undefined : json['totalTechnicallyPermittedWeight'],
