...
export interface Warning {
     ...
     * * `ROUTING_INACTIVE_ROADATTRIBUTE_SCENARIOS` - The scenarios given in options[customRoadAttributeScenarios] contain at least one which is not active.
     *   * `scenarios` - The inactive scenarioIds (comma-separated list).
     * * `ROUTING_ROADATTRIBUTES_MAYBE_IGNORED` - At least one of the scenarios given in options[customRoadAttributeScenarios] could not be fully considered in the route calculation after a map update, i.e. some road attributes may have been ignored.
     * @type {string}
     * @memberof Warning
     */
    warningCode: string;
