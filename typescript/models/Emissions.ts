...
export function EmissionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Emissions {
    ...
    return {
        ...
        'en162582012': json['en16258_2012'] == null ? undefined : EmissionsEN162582012FromJSON(json['en16258_2012']),
        'iso140832022': json['iso14083_2022'] == null ? undefined : EmissionsISO140832022FromJSON(json['iso14083_2022']),
        'iso140832023': json['iso14083_2023'] == null ? undefined : EmissionsISO140832023FromJSON(json['iso14083_2023']),
        'frenchCO2eDecree2017639': json['frenchCO2eDecree2017_639'] == null ? undefined : EmissionsFrenchCO2eDecree2017639FromJSON(json['frenchCO2eDecree2017_639']),
    };
}
