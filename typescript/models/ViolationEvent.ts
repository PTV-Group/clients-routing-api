...
export function ViolationEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): ViolationEvent {
    ...
    return {
        ...
        'violatedVehicleProperties': !exists(json, 'violatedVehicleProperties') ? undefined : ((json['violatedVehicleProperties'] as Array<any>).map(ViolatedVehiclePropertyFromJSON)),
...
export function ViolationEventToJSON(value?: ViolationEvent | null): any {
    ...
    return {
        ...
        'violatedVehicleProperties': value.violatedVehicleProperties === undefined ? undefined : ((value.violatedVehicleProperties as Array<any>).map(ViolatedVehiclePropertyToJSON)),
