...
export function EventFromJSONTyped(json: any, ignoreDiscriminator: boolean): Event {
    ...
    return {
        ...
        'lowEmissionZone': !exists(json, 'lowEmissionZone') ? undefined : LowEmissionZoneEventFromJSON(json['lowEmissionZone']),
        'evStatus': !exists(json, 'evStatus') ? undefined : EvStatusEventFromJSON(json['evStatus']),
        'charge': !exists(json, 'charge') ? undefined : ChargeEventFromJSON(json['charge']),
    };
}
