...
public class Event {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(latitude, longitude, startsAt, distanceFromStart, travelTimeFromStart, countryCode, utcOffset, toll, maneuver, border, violation, waypoint, utcOffsetChange, schedule, combinedTransport, traffic, lowEmissionZone, evStatus, charge);
  }
