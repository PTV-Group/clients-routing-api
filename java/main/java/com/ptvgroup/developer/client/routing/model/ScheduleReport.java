...
/**
 * Provides an overview of the times of the schedule of this route including break and rest times. Requires _SCHEDULE_REPORT_ to be requested, POST only.
 */
@ApiModel(description = "Provides an overview of the times of the schedule of this route including break and rest times. Requires _SCHEDULE_REPORT_ to be requested, POST only.")
@JsonPropertyOrder({
