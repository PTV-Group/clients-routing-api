...
public class ManeuverEvent {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `relativeDirection` to the URL query string
    if (getRelativeDirection() != null) {
      joiner.add(String.format("%srelativeDirection%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getRelativeDirection()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `absoluteDirection` to the URL query string
    if (getAbsoluteDirection() != null) {
      joiner.add(String.format("%sabsoluteDirection%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAbsoluteDirection()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `roadAhead` to the URL query string
    if (getRoadAhead() != null) {
      joiner.add(getRoadAhead().toUrlQueryString(prefix + "roadAhead" + suffix));
    }

    // add `directionSignText` to the URL query string
    if (getDirectionSignText() != null) {
      joiner.add(String.format("%sdirectionSignText%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDirectionSignText()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `exitNumber` to the URL query string
    if (getExitNumber() != null) {
      joiner.add(String.format("%sexitNumber%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getExitNumber()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `exitName` to the URL query string
    if (getExitName() != null) {
      joiner.add(String.format("%sexitName%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getExitName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `roundaboutExit` to the URL query string
    if (getRoundaboutExit() != null) {
      joiner.add(String.format("%sroundaboutExit%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getRoundaboutExit()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `combinedTransportName` to the URL query string
    if (getCombinedTransportName() != null) {
      joiner.add(String.format("%scombinedTransportName%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCombinedTransportName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `combinedTransportType` to the URL query string
    if (getCombinedTransportType() != null) {
      joiner.add(String.format("%scombinedTransportType%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCombinedTransportType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `crossingRoadName` to the URL query string
    if (getCrossingRoadName() != null) {
      joiner.add(String.format("%scrossingRoadName%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCrossingRoadName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
