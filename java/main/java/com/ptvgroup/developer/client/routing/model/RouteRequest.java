...
public class RouteRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Instead of the list of waypoints, a **routeId** from a previously calculated route or a matched track can be entered. See [here](./Concepts/Waypoints.htm) for more information.")
