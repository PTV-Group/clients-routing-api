...
public class TollSectionCost {
  ...
  private List<String> etcSubscriptions = null;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The required electronic toll collection subscriptions for the payment method _ELECTRONIC_TOLL_COLLECTION_SUBSCRIPTION_.")
