...
public class AlternativeRoute {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "false", required = true, value = "If the alternative route cannot be calculated for the given vehicle the resulting alternative route is marked as violated.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ID of the alternative route.")
