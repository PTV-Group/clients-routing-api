...
public class TrafficEvent {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The polyline of the traffic event in the format specified by **options[polylineFormat]**. Only present for **accessType** _ENTER_. Requires _TRAFFIC_EVENTS_POLYLINE_ to be requested.")
