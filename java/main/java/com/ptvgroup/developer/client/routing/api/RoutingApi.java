...
public class RoutingApi {
  ...
  private HttpRequest.Builder calculateRouteRequestBuilder(List<String> waypoints, UUID routeId, String profile, Vehicle vehicle, Options options, MonetaryCostOptions monetaryCostOptions, List<Results> results) throws ApiException {
    ...
    if (vehicle != null) {
      ...
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[co2EmissionClass]", vehicle.getCo2EmissionClass()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[lowEmissionZoneTypes]", vehicle.getLowEmissionZoneTypes()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[lowEmissionZoneApprovals]", vehicle.getLowEmissionZoneApprovals()));
      ...
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[totalTechnicallyPermittedWeight]", vehicle.getTotalTechnicallyPermittedWeight()));
      ...
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[hazardousMaterials]", vehicle.getHazardousMaterials()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[tunnelRestrictionCode]", vehicle.getTunnelRestrictionCode()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[truckRoutes]", vehicle.getTruckRoutes()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[commercial]", vehicle.getCommercial()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("vehicle[etcSubscriptions]", vehicle.getEtcSubscriptions()));
    }
    if (options != null) {
      ...
      localVarQueryParams.addAll(ApiClient.parameterToPairs("options[allowedCountries]", options.getAllowedCountries()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("options[prohibitedCountries]", options.getProhibitedCountries()));
      ...
      localVarQueryParams.addAll(ApiClient.parameterToPairs("options[avoid]", options.getAvoid()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("options[blockIntersectingRoads]", options.getBlockIntersectingRoads()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("options[customRoadAttributeScenarios]", options.getCustomRoadAttributeScenarios()));
   ...
   * @throws ApiException if fails to make API call
   */
  public RouteResponse calculateRoutePost(RouteRequest routeRequest, String profile, Vehicle vehicle, Driver driver, Options options, MonetaryCostOptions monetaryCostOptions, EvOptions evOptions, List<Results> results) throws ApiException {
    ApiResponse<RouteResponse> localVarResponse = calculateRoutePostWithHttpInfo(routeRequest, profile, vehicle, driver, options, monetaryCostOptions, evOptions, results);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RouteResponse> calculateRoutePostWithHttpInfo(RouteRequest routeRequest, String profile, Vehicle vehicle, Driver driver, Options options, MonetaryCostOptions monetaryCostOptions, EvOptions evOptions, List<Results> results) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = calculateRoutePostRequestBuilder(routeRequest, profile, vehicle, driver, options, monetaryCostOptions, evOptions, results);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder calculateRoutePostRequestBuilder(RouteRequest routeRequest, String profile, Vehicle vehicle, Driver driver, Options options, MonetaryCostOptions monetaryCostOptions, EvOptions evOptions, List<Results> results) throws ApiException {
    ...
    if (evOptions != null) {
      localVarQueryParams.addAll(ApiClient.parameterToPairs("evOptions[initialStateOfCharge]", evOptions.getInitialStateOfCharge()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("evOptions[minimumStateOfCharge]", evOptions.getMinimumStateOfCharge()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("evOptions[energyEfficientRoute]", evOptions.getEnergyEfficientRoute()));
    }
    localVarQueryParams.addAll(ApiClient.parameterToPairs("csv", "results", results));
   ...
   * @throws ApiException if fails to make API call
   */
  public EtaResponse getEstimatedTimeOfArrival(UUID routeId, PositionAtWaypoint waypoint, PositionOnRoute position, WorkLogbook workLogbook) throws ApiException {
    ApiResponse<EtaResponse> localVarResponse = getEstimatedTimeOfArrivalWithHttpInfo(routeId, waypoint, position, workLogbook);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<EtaResponse> getEstimatedTimeOfArrivalWithHttpInfo(UUID routeId, PositionAtWaypoint waypoint, PositionOnRoute position, WorkLogbook workLogbook) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getEstimatedTimeOfArrivalRequestBuilder(routeId, waypoint, position, workLogbook);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        return new ApiResponse<EtaResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<EtaResponse>() {}) // closes the InputStream
  ...
  private HttpRequest.Builder getEstimatedTimeOfArrivalRequestBuilder(UUID routeId, PositionAtWaypoint waypoint, PositionOnRoute position, WorkLogbook workLogbook) throws ApiException {
    ...
    List<Pair> localVarQueryParams = new ArrayList<>();
    if (waypoint != null) {
      localVarQueryParams.addAll(ApiClient.parameterToPairs("waypoint[name]", waypoint.getName()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("waypoint[performedServiceTime]", waypoint.getPerformedServiceTime()));
    }
    if (position != null) {
      localVarQueryParams.addAll(ApiClient.parameterToPairs("position[latitude]", position.getLatitude()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("position[longitude]", position.getLongitude()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("position[nextWaypointName]", position.getNextWaypointName()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("position[heading]", position.getHeading()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("position[headingTolerance]", position.getHeadingTolerance()));
    }
    if (workLogbook != null) {
      localVarQueryParams.addAll(ApiClient.parameterToPairs("workLogbook[lastTimeTheDriverWorked]", workLogbook.getLastTimeTheDriverWorked()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("workLogbook[accumulatedDrivingTimeSinceLastBreak]", workLogbook.getAccumulatedDrivingTimeSinceLastBreak()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("workLogbook[accumulatedWorkingTimeSinceLastBreak]", workLogbook.getAccumulatedWorkingTimeSinceLastBreak()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("workLogbook[accumulatedDrivingTimeSinceLastDailyRest]", workLogbook.getAccumulatedDrivingTimeSinceLastDailyRest()));
      localVarQueryParams.addAll(ApiClient.parameterToPairs("workLogbook[accumulatedTravelTimeSinceLastDailyRest]", workLogbook.getAccumulatedTravelTimeSinceLastDailyRest()));
    }
