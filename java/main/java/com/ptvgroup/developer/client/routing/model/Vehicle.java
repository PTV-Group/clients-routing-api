...
public class Vehicle {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Comma-separated list of the low-emission zone types of the vehicle. For now, types are available only for Germany, so using more than one value is not allowed.  Relevant for `routing`. ")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A comma separated list of ETC Subscriptions. See [here](./Concepts/Electronic%20Toll%20Collection.htm) for more information on available subscriptions.  Relevant for `toll`. ")
  @JsonIgnore
