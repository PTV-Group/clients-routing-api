...
public class Vehicle {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The CO&#8322; emission class valid in the European Union. See also the  [Directive 1999/62/EC](https://eur-lex.europa.eu/eli/dir/1999/62) of the European Parliament and of the  Council on the charging of heavy goods vehicles for the use of certain infrastructures, article 7ga.  Relevant for `toll`. ")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Comma-separated list of the low-emission zone types of the vehicle. For now, types are available only for Germany, so using more than one value is not meaningful.  Available values are provided by type `LowEmissionZoneTypes`: \"DE_GREEN\" \"DE_YELLOW\" \"DE_RED\" \"DE_NONE\"   Relevant for `routing`. ")
  @JsonIgnore
