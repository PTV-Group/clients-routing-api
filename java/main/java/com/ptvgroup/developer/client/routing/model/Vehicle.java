...
public class Vehicle {
  ...
  private JsonNullable<String> lowEmissionZoneTypes = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_LOW_EMISSION_ZONE_APPROVALS = "lowEmissionZoneApprovals";
  private JsonNullable<String> lowEmissionZoneApprovals = JsonNullable.<String>undefined();
  ...
  private JsonNullable<Integer> totalTechnicallyPermittedWeight = JsonNullable.<Integer>undefined();
  ...
  private JsonNullable<String> hazardousMaterials = JsonNullable.<String>undefined();
  ...
  private JsonNullable<String> truckRoutes = JsonNullable.<String>undefined();
  ...
  private JsonNullable<String> etcSubscriptions = JsonNullable.<String>undefined();
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The CO&#8322; emission class valid in the European Union. See also the  [Directive 1999/62/EC](https://eur-lex.europa.eu/eli/dir/1999/62/2022-03-24) of the European Parliament and  of the Council on the charging of heavy goods vehicles for the use of certain infrastructures, Article 7ga.  Relevant for `toll`. ")
  @JsonIgnore
  ...
  public Vehicle lowEmissionZoneTypes(String lowEmissionZoneTypes) {
    this.lowEmissionZoneTypes = JsonNullable.<String>of(lowEmissionZoneTypes);
    return this;
  }
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Comma-separated list of the low-emission zone types of the vehicle. This parameter is deprecated and superseded by **lowEmissionZoneApprovals**. When still being used, only low-emission zones in Germany are affected, zones in other countries which need an environmental badge or vehicle registration can be entered without restriction. It is not possible to specify both parameters.  Available values are provided by type `LowEmissionZoneTypes`:  \"DE_GREEN\", \"DE_YELLOW\", \"DE_RED\", \"DE_NONE\"  Relevant for `routing`. ")
  @JsonIgnore
  ...
  public JsonNullable<String> getLowEmissionZoneTypes_JsonNullable() {
    return lowEmissionZoneTypes;
  }
  
  @JsonProperty(JSON_PROPERTY_LOW_EMISSION_ZONE_TYPES)
  public void setLowEmissionZoneTypes_JsonNullable(JsonNullable<String> lowEmissionZoneTypes) {
  ...
  public Vehicle lowEmissionZoneApprovals(String lowEmissionZoneApprovals) {
    this.lowEmissionZoneApprovals = JsonNullable.<String>of(lowEmissionZoneApprovals);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DE_GREEN,DK_AUTHORIZED,FR_CRITAIR_1", value = "Comma-separated list of approvals to enter low-emission zones. Usually, such approvals are environmental badges to be placed on the windscreen, but that can also be any other kind of approval or vehicle registration allowing it to enter a low-emission zone.  Low-emission zones which do not need any kind of approval but depend only on the **emissionStandard** are not affected by this parameter. Instead they can be entered if the **emissionStandard**  is sufficient. Electric vehicles can always enter these zones.  The default of the selected predefined profile allows entering all low-emission zones the vehicle can get an approval for. So, if you do not want to care about that and your  vehicle operates in a region where it has all necessary approvals, leave this parameter empty.  In order to consider low-emission zones depending on the actually available approvals, i.e. on  the environmental badges on the windscreen and other vehicle registrations, specify all of them here. The vehicle can then enter only those zones for which a proper approval is present. Low-emission zones in countries for which no value is specified cannot be entered.  Available values are:  \"NONE\", \"AT_EURO_1\", \"AT_EURO_2\", \"AT_EURO_3\", \"AT_EURO_4\", \"AT_EURO_5\", \"AT_EURO_6\", \"DE_GREEN\", \"DE_YELLOW\", \"DE_RED\", \"DK_AUTHORIZED\", \"ES_CAT_B\", \"ES_CAT_C\", \"ES_CAT_ECO\", \"ES_CAT_ZERO\", \"FR_CRITAIR_0\", \"FR_CRITAIR_1\", \"FR_CRITAIR_2\", \"FR_CRITAIR_3\", \"FR_CRITAIR_4\", \"FR_CRITAIR_5\"  This list can be extended at any time, clients should handle unknown values properly. Only one value per country can be specified. Relevant for `routing`. See [here](./concepts/low-emission-zones) for more information. ")
  @JsonIgnore

  public String getLowEmissionZoneApprovals() {
        return lowEmissionZoneApprovals.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_LOW_EMISSION_ZONE_APPROVALS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getLowEmissionZoneApprovals_JsonNullable() {
    return lowEmissionZoneApprovals;
  }
  
  @JsonProperty(JSON_PROPERTY_LOW_EMISSION_ZONE_APPROVALS)
  public void setLowEmissionZoneApprovals_JsonNullable(JsonNullable<String> lowEmissionZoneApprovals) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "15000", value = "The empty weight of the vehicle [kg].  Relevant for `routing`, `emissions`, `range calculation`. ")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "25000", value = "The weight of the vehicle's load [kg].  Relevant for `routing`, `emissions`, `range calculation`. ")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "40000", value = "The total permitted weight of the vehicle and its load [kg]. This is the weight the vehicle is usually registered with. If this value is not specified but **totalTechnicallyPermittedWeight** is specified then that value is used  for both **totalPermittedWeight** and **totalTechnicallyPermittedWeight**.  Relevant for `routing`, `toll`, `emissions`. ")
  @JsonIgnore
  ...
  public Vehicle totalTechnicallyPermittedWeight(Integer totalTechnicallyPermittedWeight) {
    this.totalTechnicallyPermittedWeight = JsonNullable.<Integer>of(totalTechnicallyPermittedWeight);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "40000", value = "The total technically permitted weight of the vehicle and its load [kg].  Sometimes vehicles are registered with a smaller **totalPermittedWeight** than technically possible. For  such cases the possibly larger total technically permitted weight is specified here, it is relevant for  toll calculation in some European countries. If this value is not specified but **totalPermittedWeight** is specified then that value is used  for both **totalPermittedWeight** and **totalTechnicallyPermittedWeight**.  Relevant for `toll`. ")
  @JsonIgnore

  public Integer getTotalTechnicallyPermittedWeight() {
        return totalTechnicallyPermittedWeight.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_TOTAL_TECHNICALLY_PERMITTED_WEIGHT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Integer> getTotalTechnicallyPermittedWeight_JsonNullable() {
    return totalTechnicallyPermittedWeight;
  }
  
  @JsonProperty(JSON_PROPERTY_TOTAL_TECHNICALLY_PERMITTED_WEIGHT)
  public void setTotalTechnicallyPermittedWeight_JsonNullable(JsonNullable<Integer> totalTechnicallyPermittedWeight) {
  ...
  **/
  ...
  public Vehicle hazardousMaterials(String hazardousMaterials) {
    this.hazardousMaterials = JsonNullable.<String>of(hazardousMaterials);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Comma-separated list of hazardous materials the vehicle has loaded. If _NONE_ is specified along with other hazardous materials it is ignored. Depending on the load the route will avoid roads prohibited for and/or prefer roads prescribed for specific hazardous materials.  Available values are provided by type `HazardousMaterials`: \"HAZARDOUS_TO_WATER\" \"EXPLOSIVE\" \"FLAMMABLE\" \"RADIOACTIVE\" \"INHALATION_HAZARD\" \"MEDICAL_WASTE\" \"OTHER\" \"NONE\"  Relevant for `routing`. ")
  @JsonIgnore
  ...
  public JsonNullable<String> getHazardousMaterials_JsonNullable() {
    return hazardousMaterials;
  }
  
  @JsonProperty(JSON_PROPERTY_HAZARDOUS_MATERIALS)
  public void setHazardousMaterials_JsonNullable(JsonNullable<String> hazardousMaterials) {
  ...
  **/
  ...
  public Vehicle truckRoutes(String truckRoutes) {
    this.truckRoutes = JsonNullable.<String>of(truckRoutes);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<String> getTruckRoutes_JsonNullable() {
    return truckRoutes;
  }
  
  @JsonProperty(JSON_PROPERTY_TRUCK_ROUTES)
  public void setTruckRoutes_JsonNullable(JsonNullable<String> truckRoutes) {
  ...
  **/
  ...
  public Vehicle etcSubscriptions(String etcSubscriptions) {
    this.etcSubscriptions = JsonNullable.<String>of(etcSubscriptions);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A comma separated list of ETC Subscriptions. See [here](./concepts/electronic-toll-collection) for more information on available subscriptions.  Available values are provided by type `EtcSubscriptionTypes`: \"AT_GOBOX\" \"BE_TELETOL\" \"BE_VIAPASS\" \"CH_LSVA\" \"DE_QUICKBOX\" \"DE_TOLLCOLLECT\" \"DE_WARNOWTUNNEL_RFID\" \"DK_BROPAS_BUSINESS\" \"IT_TELEPASS\" \"NL_TELECARD\" \"NL_TTAG\" \"NO_AUTOPASS\" \"PT_VIA_VERDE\" \"US_APASS\" \"US_BREEZEBY\" \"US_DOWNBEACH_EXPRESSPASS\" \"US_EPASS\" \"US_EXPRESSACCOUNT\" \"US_EXPRESSCARD\" \"US_EXPRESSPASS\" \"US_EXPRESSTOLL\" \"US_EZPASS\" \"US_EZTAG\" \"US_FASTRAK\" \"US_GEAUXPASS\" \"US_GOODTOGO\" \"US_GOPASS\" \"US_IPASS\" \"US_KTAG\" \"US_LEEWAY\" \"US_MACKINACBRIDGE_MACPASS\" \"US_MARYLAND_EZPASS\" \"US_MASSACHUSETTS_EZPASS\" \"US_NC_QUICKPASS\" \"US_NEWHAMPSHIRE_EZPASS\" \"US_NEWJERSEY_EZPASS\" \"US_NEWYORK_EZPASS\" \"US_NEXPRESS\" \"US_OHIO_EZPASS\" \"US_PALPASS\" \"US_PIKEPASS\" \"US_RIVERLINK\" \"US_RIVERLINK_NOTRANSPONDER\" \"US_SEAWAYTRANSITCARD\" \"US_SUNPASS\" \"US_TOLLTAG\" \"US_TXTAG\" \"US_VIRGINIA_EZPASS\" \"US_WESTVIRGINIA_EZPASS\" \"US_PEACHPASS\" \"US_NEXUS\" \"US_DELAWARE_EZPASS\" \"US_GROSSEILETOLLBRIDGE_PASSTAG\" \"US_EZPASS_PAYBYPLATE\"  Relevant for `toll`. ")
  @JsonIgnore
  ...
  public JsonNullable<String> getEtcSubscriptions_JsonNullable() {
    return etcSubscriptions;
  }
  
  @JsonProperty(JSON_PROPERTY_ETC_SUBSCRIPTIONS)
  public void setEtcSubscriptions_JsonNullable(JsonNullable<String> etcSubscriptions) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.engineType, vehicle.engineType) &&
        ...
        equalsNullable(this.lowEmissionZoneApprovals, vehicle.lowEmissionZoneApprovals) &&
        ...
        equalsNullable(this.totalTechnicallyPermittedWeight, vehicle.totalTechnicallyPermittedWeight) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(engineType), hashCodeNullable(fuelType), hashCodeNullable(electricityType), hashCodeNullable(averageFuelConsumption), hashCodeNullable(averageElectricityConsumption), hashCodeNullable(bioFuelRatio), hashCodeNullable(hybridRatio), hashCodeNullable(dualFuelRatio), hashCodeNullable(cylinderCapacity), hashCodeNullable(emissionStandard), hashCodeNullable(co2EmissionClass), hashCodeNullable(lowEmissionZoneTypes), hashCodeNullable(lowEmissionZoneApprovals), hashCodeNullable(particleReductionClass), hashCodeNullable(emptyWeight), hashCodeNullable(loadWeight), hashCodeNullable(totalPermittedWeight), hashCodeNullable(totalTechnicallyPermittedWeight), hashCodeNullable(axleWeight), hashCodeNullable(numberOfAxles), hashCodeNullable(numberOfTires), hashCodeNullable(height), hashCodeNullable(heightAboveFrontAxle), hashCodeNullable(length), hashCodeNullable(width), hashCodeNullable(hazardousMaterials), hashCodeNullable(tunnelRestrictionCode), hashCodeNullable(truckRoutes), hashCodeNullable(commercial), hashCodeNullable(etcSubscriptions));
  }
